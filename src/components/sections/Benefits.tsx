import { DIFFERENTIATORS } from '../../data/clinic'
...
export function Benefits() {
  return (
    <section id="diferenciadores" className="section-padding bg-white">
      <div className="container-narrow">
        <SectionHeading
          eyebrow="¿Por qué elegirnos?"
          title="¿Por qué elegir Clínica del Dolor?"
          subtitle="Combinamos especialización médica, tecnología moderna y un modelo integral que te acompaña desde el diagnóstico hasta tu recuperación."
        />
